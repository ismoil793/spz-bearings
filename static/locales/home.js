   ...
   ru: {
      ...
      slider: [{
      ...
      },
         {
            ...
            description: "Изготовим подшипники любой сложности, качество будет соответствующим к ГОСТ, цена обрадует Вас.",
            button: 'Подробнее'
         },
         {
      ...
      product_demand: {
         mainTitle: "Продукция востребована в секторах",
         cards: [{
            title: 'Железнодорожная-промышленность',
            details: ["Подшипники", "Валы", "Шестерни", "Гайки", "Болты"]
         },
            {
               title: 'Автопромышленность',
               details: ["Подшипники", "Валы", "Шестерни", "Гайки", "Болты"]
            },
            {
               title: 'Энергетика',
      ...
      redirect_card: {
         title: "Наша продукция востребована и в других секторах.",
