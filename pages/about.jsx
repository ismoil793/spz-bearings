       ...
       <>
          ...
          <div className="super_container">
             ...
             <Layout
                 ...
                 pageInfo={[`${AboutText[props.locale].breadcrumb.crumbs[0]}`, `${AboutText[props.locale].breadcrumb.crumbs[1]}`]}
                 locale={props.locale}
             >
                               ...
                               <div class="vision_item">
                                  ...
                                  <div class="container">
                                     ...
                                     <ul className="circle_list">
                                        {AboutText[props.locale].specificity_section.elements[0].descriptionList.map(element => (
                                            <li>{element}</li>))}
                                     </ul>
                                  </div>
                               </div>
                            ...
                            <div class="col-md-6">
                               <div class="vision_item pl_100">
                                  ...
                                  <div class="container">
                                     ...
                                     <ul className="circle_list">
                                        {AboutText[props.locale].specificity_section.elements[1].descriptionList.map(element => (
                                            <li>{element}</li>))}
                                     </ul>
                                  </div>
                               </div>
                      ...
                      <div class="container">
                         <div class="row flex-row-reverse align-items-center service_teb_item">
                            ...
                            <div class="about_page images_container">
                               <div
                                   class="col-md-3 col-sm-6 order-md-2 order-sm-4 item-sertificates clearfix image_item_wrapper">
                                  {" "}
                               ...
                               <div
                                   class="col-md-3 col-sm-6 order-md-4 order-sm-1 item-sertificates clearfix image_item_wrapper">
                                  {" "}
                               ...
                               <div
                                   class="col-md-3 col-sm-6 order-md-1 order-sm-2 item-sertificates clearfix image_item_wrapper">
                                  {" "}
                               ...
                               <div
                                   class="col-md-3 col-sm-6  order-md-3 order-sm-3 item-sertificates clearfix image_item_wrapper">
                                  {" "}
