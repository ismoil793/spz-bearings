          ...
          <main id="content" role="main">
            ...
            <section class="product_area pt_200 shops_catalogs_page-section">
              ...
              <div className="tabs">
                ...
                <input name="tabs" type="radio" id="tab-1" checked={checkedArray[0]}  class="input" onClick={(e)=>{SetChecked(0); console.log(checkedArray)}} />
                ...
                <input name="tabs" checked={checkedArray[1]}  type="radio" id="tab-2" class="input" onClick={(e)=>{SetChecked(1); console.log(checkedArray)}}  />
                ...
                <input name="tabs" checked={checkedArray[2]} type="radio" id="tab-3" class="input" onClick={(e)=>{SetChecked(2); console.log(checkedArray)}}  />
                ...
                <input name="tabs" checked={checkedArray[3]} type="radio" id="tab-4" class="input" onClick={(e)=>{SetChecked(3); console.log(checkedArray)}}  />
                ...
                <input name="tabs" checked={checkedArray[4]} type="radio" id="tab-5" class="input" onClick={(e)=>{SetChecked(4); console.log(checkedArray)}}  />
