                         ...
                         <div class="row product_details_inner">
                            ...
                            <div class="col-lg-6">
                               <div class="p_details_text">
                                  ...
                                  <p>
                                     РАДИАЛЬНЫЕ ОДНОРЯДНЫЕ ШАРИКОВЫЕ ПОДШИПНИКИ СЕРИЯ: 60… 62… 63… 64… 622.. 623… 160…
                                     618… 619…
                                  </p>
                               ...
                               >
                                  <div class="row centered">
                                     ...
                                     <img className="product_description_section_img"
                                          src={dataArray.podshipniki['sharikovyiy-radialnyiy'].content[1].url}/>
                                     <h5 className="description_title col-12">{dataArray.podshipniki['sharikovyiy-radialnyiy'].content[3].decription[2]}</h5>
                                     <img className="product_description_section_img"
                                          src={dataArray.podshipniki['sharikovyiy-radialnyiy'].content[2].url}/>
                                  </div>
                               </div>
                               ...
                               >
                                  <div class="row centered">
                                     ...
                                     <div className="row centered">
                                        <img className="description_gost_images col-lg-6"
                                             src={dataArray.podshipniki['sharikovyiy-radialnyiy'].content[3].imagesSRC[0]}/>
                                        <img className="description_gost_images col-lg-6"
                                             src={dataArray.podshipniki['sharikovyiy-radialnyiy'].content[3].imagesSRC[1]}/>
                                     </div>
                                     <h5 className="description_title col-12">{dataArray.podshipniki['sharikovyiy-radialnyiy'].content[3].decription[1]}</h5>
                                     <div className="row centered">
                                        <img className="description_gost_images col-lg-6"
                                             src={dataArray.podshipniki['sharikovyiy-radialnyiy'].content[3].imagesSRC[2]}/>
                                        <img className="description_gost_images col-lg-6"
                                             src={dataArray.podshipniki['sharikovyiy-radialnyiy'].content[3].imagesSRC[3]}/>
                                        <img className="description_gost_images col-lg-6"
                                             src={dataArray.podshipniki['sharikovyiy-radialnyiy'].content[3].imagesSRC[4]}/>
                                        <img className="description_gost_images col-lg-6"
                                             src={dataArray.podshipniki['sharikovyiy-radialnyiy'].content[3].imagesSRC[5]}/>
                                     </div>
                                     <h5 className="description_title col-12">{dataArray.podshipniki['sharikovyiy-radialnyiy'].content[3].decription[2]}</h5>
                                     <div className="row centered">
                                        <img className="description_gost_images col-lg-6"
                                             src={dataArray.podshipniki['sharikovyiy-radialnyiy'].content[3].imagesSRC[6]}/>
