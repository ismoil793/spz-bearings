         ...
         content: [
            {
               ...
               contentTable: (
                   ...
                   <tr>
                      ...
                      <td>B</td>
                      <td>Подшипники, соответствующие ISO стандартам,&nbsp;с габаритными размерами,
                         соответствующими&nbsp;номеру изделия, но с разной внутренней формой,&nbsp;более крутой угол
                         наружного кольца
                      </td>
                   </tr>
                   <tr>
                               ...
                               >
                                  <div class="row centered">
                                     ...
                                     <img className="product_description_section_img"
                                          src={dataArray.podshipniki['rolikovyiy-konicheskiy'].content[1].url}/>
                                  </div>
                               </div>
