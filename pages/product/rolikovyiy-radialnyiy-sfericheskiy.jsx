         ...
         content: [
            {
               ...
               contentTable: (
                   ...
                   <tr>
                      ...
                      <td>C</td>
                      <td>Подшипники с двумя штампованными стальными &nbsp;сепараторами оконного типа, с внутренним
                         кольцом&nbsp;без фланцев и плавучим направляющим кольцом&nbsp;центрированным по внутреннему
                         кольцу
                      </td>
                   </tr>
                   <tr>
                               ...
                               >
                                  <div class="row centered">
                                     ...
                                     <img className="product_description_section_img"
                                          src={dataArray.podshipniki['rolikovyiy-radialnyiy-sfericheskiy'].content[1].url}/>
                                  </div>
                               </div>
