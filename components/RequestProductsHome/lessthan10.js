...
export default class Less10products extends React.Component {
  handleParent = () => {
    this.props.change();
  };
  handleCompare = () => {
  ...
  render() {
    return (
      <>
        {this.props.less10products ? (
        <ul className="row list-unstyled products-group no-gutters mb-0 overflow-visible">
            {typeof this.props.less10products.product_request == "object"
              ? this.props.less10products.product_request.slice(0,6).map(request => (
                    ...
                    <div className="product-item__inner p-md-3 row no-gutters">
                        ...
                        >
                            <div className="col col-lg-auto pointer product-media-left">
                                <a className="max-width-150 d-block"><img className="img-fluid" src={request.images[0] ? request.images[0].types.small_default : null}  alt="Image Description"/></a>
                            </div>
                            </Link>
                            ...
                            <Link
                              ...
                              >
                                <div className="mb-4">
                                    ...
                                    <h5 className="product-item__title"><a  className="text-blue pointer font-weight-bold">{request.name}</a></h5>
                                </div>
                                </Link>
