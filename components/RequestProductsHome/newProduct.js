  ...
  render() {
    return (
      ...
      {this.props.newproducts ? (
          ...
          {typeof this.props.newproducts.product_request == "object"
              ? this.props.newproducts.product_request.map(request => (
            <li className="col-6 col-wd-3 col-md-4 product-item" key={request.id}>
                <div className="product-item__outer h-100">
                    <div className="product-item__inner px-xl-4 p-3">
                        ...
                        >
                            <h5 className="mb-1 product-item__title"><a className="text-blue font-weight-bold">{request.name}</a></h5>
                          </Link>
                            <Link
                              href={{
                                pathname: "/product/[product]"
                            ...
                            >
                            <div className="mb-2">
                                <a className="d-block text-center"><img className="img-fluid" src={request.images[0].types.medium_default} alt="Image Description"/></a>
                            </div>
