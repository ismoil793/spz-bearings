...
export default class Less2products extends React.Component {
  handleParent = () => {
    this.props.change();
  };
  handleCompare = () => {
  ...
  render() {
    return (
      <>
        ...
        {this.props.less2products ? (
        <ul className="row list-unstyled products-group no-gutters mb-0 overflow-visible">
            {typeof this.props.less2products.product_request == "object"
              ? this.props.less2products.product_request.slice(0,6).map(request => (
                    ...
                    <div className="product-item__outer h-100">
                        ...
                        >
                            <div className="col col-lg-auto product-media-left">
                                <a className="max-width-150 pointer d-block"><img className="img-fluid" src={request.images[0].types.small_default}  alt="Image Description"/></a>
                            </div>
                        </Link>
                        ...
                        <Link
                              ...
                              >
                                <div className="mb-4">
                                    <div className="mb-2"><a href="../shop/product-categories-7-column-full-width.html" className="font-size-12 text-gray-5">{request.country ?  request.country.name : ''}</a></div>
